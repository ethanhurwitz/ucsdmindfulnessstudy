...
function assignScenario() {
  ...
  if (true) {
    ...
    alert("Missing data. Please double check for missing answers.") // translation
  }
...
function instructioncheck() {
  ...
  if (checksum === 3) {
    ...
    alert('You have answered some questions incorrectly. Please try again.'); // translation
...
function onButtonInstructionsPressed(evt) {
  ...
  if (instructionsCounter == 0) {
    ...
    if (clicks > 0) {
      alert("Please use all 25 clicks to explore the game board.");
      return;
    }
    gridDeactivated = true;
...
//   change("remaining2", "Verbleibende Klicks: <b>" + clicks + "</b>");
    change("remaining2", "Remaining Clicks: <b>" + clicks + "</b>"); // translation
...
//   change('scoretotal', "Punktzahl: " + scoretotal[trialCounter]);
  change('scoretotal', "Score: " + scoretotal[trialCounter]); // translation
  ...
  if (clicks == 0) {
    ...
    var remainingMsg = trials == 1 ? "round remaining" : "rounds remaining"; // translation
    // completionDiv = "<br><br><br><br><h1 class=\"text-xl\">You have explored this game board and have <b>"  // translation
    //   + starRating + " stars collected</b>. You have " + (trials) + " " + remainingMsg + "</h1><br><br><br>"  // translation
    //   + starDiv + "<br><br><br>";
    completionDiv = "<br><br><br><br><h1 class=\"text-xl\">You finished this round and have <b>"  // translation
      + starRating + " stars collected</b>. You have " + trials + " " + remainingMsg + "!</h1><br><br><br>"  // translation
      + starDiv + "<br><br><br>";
  ...
  if (trials == 0 && clicks == 0) {
    ...
    //   completionDiv = "<h1 class=\"text-xl\">Wow! Das hast du super gemacht! Und du hast insgesamt ganze <b>" + finalStarCount + " Sterne gesammelt</b>! Vielen Dank fürs Spielen!</b> </h1>" + finalStarDiv + "";
      completionDiv = "<h1 class=\"text-xl\">Great job! You earned a total of <b>" + finalStarCount + " stars</b>! Thank you for playing!</b> </h1>" + finalStarDiv + ""; // translation
...
function saveBonusStep() {
  ...
  if (sicherValue == null || !sliderMoved || !confidenceSliderMoved) {
    ...
    alert("Please enter values for both controllers"); // translation
    return;
  }  
...
//   var r = confirm("Bist du dir sicher?");
  var r = confirm("Are you sure?"); // translation
  if (!r) return;
...
function nexttrial() {
  ...
  if (trials >= 0) {
    ...
    change("remaining1", "Remaining Rounds: <b>" + (trials) + "</b>"); // translation
    // change("remaining2", "Verbleibende Klicks: <b>" + clicks + "</b>");
    change("remaining2", "Remaining Clicks: <b>" + clicks + "</b>"); // translation
