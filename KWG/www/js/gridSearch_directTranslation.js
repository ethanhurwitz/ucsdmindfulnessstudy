...
function onButtonInstructionsPressed(evt) {
  ...
  if (instructionsCounter == 0) {
    ...
    if (clicks > 0) {
      alert("Please use all 25 clicks to explore the playing field.");
      return;
    }
    gridDeactivated = true;
...
//   change('scoretotal', "Punktzahl: " + scoretotal[trialCounter]);
  ...
  if (clicks == 0) {
    ...
    var remainingMsg = (trials - 1) == 1 ? "another field." : "other fields."; // translation
    // completionDiv = "<br><br><br><br><h1 class=\"text-xl\">Du hast dieses Feld erkundet und hast <b>"
    completionDiv = "<br><br><br><br><h1 class=\"text-xl\">You have explored this field and have <b>"  // translation
    //   + starRating + " Sterne gesammelt</b>. Du hast noch " + (trials) + " " + remainingMsg + "</h1><br><br><br>"
      + starRating + " stars collected</b>. You still have " + (trials) + " " + remainingMsg + "</h1><br><br><br>"  // translation
      + starDiv + "<br><br><br>";
  ...
  if (trials == 0 && clicks == 0) {
    ...
    //   completionDiv = "<h1 class=\"text-xl\">Wow! Das hast du super gemacht! Und du hast insgesamt ganze <b>" + finalStarCount + " Sterne gesammelt</b>! Vielen Dank fürs Spielen!</b> </h1>" + finalStarDiv + "";
      completionDiv = "<h1 class=\"text-xl\">Wow! You did a great job! And you have a total of <b>" + finalStarCount + " stars collected</b>! Thank you for playing!</b> </h1>" + finalStarDiv + ""; // translation
...
function nexttrial() {
  ...
  if (trials >= 0) {
    ...
    change("remaining1", "Remaining Fields: <b>" + (trials + 1) + "</b>"); // translation
    // change("remaining2", "Verbleibende Klicks: <b>" + clicks + "</b>");
    change("remaining2", "Remaining Clicks: <b>" + clicks + "</b>"); // translation
