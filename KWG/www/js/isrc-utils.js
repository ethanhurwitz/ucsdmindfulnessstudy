...
var isrcUtils = {
    ...
    Setup: function () {
        ...
        // Immersive mode
        //AndroidFullScreen.immersiveMode(); //EDITED OUT
    ...
    SaveData: function() {
        ...
        isrcUtils.SaveDataToServer(isrcUtils.data); // ADDED TEST CODE

        // isrcUtils.SaveDataToOnlineServer(isrcUtils.data); // ADDED TEST CODE
        
    },

    // TEST SAVE FXN -- ADDED CODE BELOW:
    SaveDataToServer: function(curData) {
    ...
    //     xhr.open("POST", "https://madlab-research.ucsd.edu/savePentagon.php", true);
    ...
    //     console.log("test below")
    //     console.log(curData)
    //     isrcUtils.Post("https://madlab-research.ucsd.edu/savePentagon.php", {
    //         // data: curData
    //       'id': isrcUtils.data.uid,
    //       'experimenter': 'Ethan',
    //       'experimentName': 'kwg_pilot',
    //       'curData': curData
    //     })
    //     console.log('saved to online server')
    // },
    // END NEW CODE
